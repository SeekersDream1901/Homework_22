...
class Boat(Transport):
    def start_engine(self):
        return print("Двигатель лодки завелся")

    def stop_engine(self):
        return print("Двигатель лодки выключен")

    def move(self):
        return print("Лодка поехала")

    def stop(self):
        return print("Лодка остановилась")


class Car(Transport):
    def start_engine(self):
        return print("Двигатель машины заведен")
...
class Electroscooter(Transport):
    def start_engine(self):
        return print("Электроскутер заведен")

    def stop_engine(self):
        return print("Электроскутер выключен")

    def move(self):
        return print("Электроскутер движется")

    def stop(self):
        return print("Электроскутер остановился")
